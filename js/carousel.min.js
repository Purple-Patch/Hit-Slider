...
(function (factory) {factory(jQuery); })(function($){
	$.fn.jR3DCarousel = function(options){
		...
		(function setup(){
			...
			function _createControls(){
				if(_settings.rotationDirection == 'ltr'){
					_previousButton = $( "<div class='previous controls' style='left: -3px;'><img src='assets/arrow_l.png'</div>");
					_nextButton = $( "<div class='next controls' style='right: right: -3px;'><img src='assets/arrow.png'</div>");
				}else{
					_previousButton = $( "<div class='previous controls' style='left:-3px;'><img src='assets/arrow_l" +
							".png'</div>");
					_nextButton = $( "<div class='next controls' style='right:-3px;'><img src='assets/arrow.png'</div>");
				}
		...
		function _playjR3DCarousel(){
			setTimeout(_playNextSlide, 2.5e3);
		}
